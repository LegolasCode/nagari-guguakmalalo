...
Route::post('/account-request/{id}', [UserController::class, 'approve'])->name('account.approve');
Route::patch('/account-request/{id}', [UserController::class, 'reject'])->name('account.reject');