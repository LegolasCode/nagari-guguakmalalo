...
@section('title', 'Guguak Malalo | Edit Kontak Hukum')

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Kontak Hukum Nagari</h1>
</div>
...
<form action="{{ route('law.contact.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card-body bg-white mb-3 shadow-sm">
        <div class="mb-3">
            <label for="description" class="form-label">Deskripsi Umum Hukum Nagari (Opsional)</label>
