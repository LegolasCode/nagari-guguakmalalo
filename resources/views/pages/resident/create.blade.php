...
@section('title', 'Guguak Malalo | Tambah Data Penduduk')
    ...
    <div class="card-body bg-white mb-3">
      ...
      <div class="mb-3">
            ...
            <select id="bpjs_status" name="bpjs_status" class="form-control @error('bpjs_status') is-invalid @enderror" required>
                <option value="Tidak Terdaftar" {{ old('bpjs_status') == 'Tidak Terdaftar' ? 'selected' : '' }}>Tidak Terdaftar</option>
                <option value="Proses Pengajuan" {{ old('bpjs_status') == 'Proses Pengajuan' ? 'selected' : '' }}>Proses Pengajuan</option>
                <option value="Terdaftar" {{ old('bpjs_status') == 'Terdaftar' ? 'selected' : '' }}>Terdaftar</option>
            </select>
