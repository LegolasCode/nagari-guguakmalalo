...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <h1 class="fw-bold mb-3">Detail Permintaan Surat</h1>
            <p class="lead mb-4">Nomor Permintaan: <span class="fw-bold">{{ $letterRequest->request_number }}</span></p>
            ...
            <hr class="my-5">
            <a href="{{ route('my-request') }}" class="btn btn-outline-secondary">
