...
@section('title', 'Guguak Malalo | Tambah UMKM')
        ...
        @csrf
            <div class="card-body bg-white mb-3 shadow-sm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nik_pemilik') is-invalid @enderror" id="nik_pemilik" name="nik_pemilik" value="{{ old('nik_pemilik') }}">
